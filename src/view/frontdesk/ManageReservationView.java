...
public class ManageReservationView {
  ...
  public GetMenuInputResult renderReservationScreen(
    ...
    ConsoleUtil.printTitleBox("MANAGE RESERVATION (GUEST CHECK-OUT)", 96);
    ...
    int[] colWidths = {4, 12, 10, 22, 9, 10, 12, 12, 9};
    ...
    if (total == 0 || list == null) {
      ...
      TableUtil.TableSettings emptySettings =
          new TableUtil.TableSettings(new int[] {105}).setHAlign(0, TableUtil.Align.CENTER);
      boolean hasFilters =
          searchQuery != null || roomTypeFilter != null || paymentStatusFilter != null;
      String msg =
          hasFilters
  ...
  public int displayFilterMenu(String search, String roomType, String paymentStatus) {
    ConsoleUtil.clearScreen();
    ...
    System.out.println("1. Set Search Query  (Guest ID / Name / Room No. / Res. ID)");
  ...
  public String promptSearchInput(String current) {
    ...
    System.out.println(
        "Current: [ "
            ...
            + " ]");
    System.out.println();
    System.out.println("Search by: Guest ID, Guest Name, Room Number, or Reservation ID");
